...
{: .box-error}
**Error to avoid:** Never upload raw patient genomic data to a public or unencrypted cloud storage bucket. Always use compliant, access-controlled environments designed for health data.
